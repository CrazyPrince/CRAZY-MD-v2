...
cmd({
    ...
    async(Void, citel, text) => {
        ...
        await Void.sendMessage(`${citel.sender}`, {
            image: log0,
            caption: `*Group Name: CrazyMd-Support*\n*Group Link:* https://chat.whatsapp.com/Hyurt8L1oiDAXg0dadZ5mp`,
        });
